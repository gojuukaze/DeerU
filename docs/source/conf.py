...
project = 'DeerU'
copyright = '2018, gojuukaze'
author = 'gojuukaze'

import deeru
# The short X.Y version
version = deeru.__version__
# The full version, including alpha/beta/rc tags
release = deeru.__release__
...
latex_documents = [
    (master_doc, 'DeerU.tex', 'DeerU Documentation',
     'gojuukaze', 'manual'),
]
...
man_pages = [
    (master_doc, 'deeru', 'DeerU Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DeerU', 'DeerU Documentation',
     author, 'DeerU', 'One line description of project.',
     'Miscellaneous'),
]

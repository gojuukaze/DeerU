...
class Config(models.Model):
    ...
    config = ConfigField(verbose_name='v1版配置', null=True, default='')
    last_config = ConfigField(verbose_name='v1版旧配置', blank=True, null=True, default='')
    ...
    v2_schema = models.TextField(verbose_name='json-editor配置', null=True)
    # v2_script：js代码，会添加到创建json-editor之后，用于自定义配置的ui等
    v2_script = models.TextField(verbose_name='js代码', default='', blank=True)

...
from app.consts import app_config, Global_Value_Default, Global_value_cache_key, Theme_config_cache_key, Theme_cache_key
...
def get_theme_config():
    try:
        ...
        config = get_config_by_name(app_config['common_config'])

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', field_extension.fields.KFroalaField(verbose_name='正文')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('config', tool.kblog_model_field.ConfigField(verbose_name='配置')),
                ('last_config', tool.kblog_model_field.ConfigField(blank=True, verbose_name='旧配置')),
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('modified_time', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
            ],
            options={
